...
<meta name="description" content="Sound Core Studios is professional audio production, tracking, mixing and mastering in the Southern Illinois Area. We helped produced for many different artists in Southern Illinois. We offer different studio packages to help you get the right sound and product. ">
<meta name="keywords" content="carbondale studio, carbondale audio, sound core music studios, sound core studios, carbondale audio productions, carbondale mixing, carbondale audio mastering, carbondale recording, ">
<meta charset='UTF-8'>


<title>Sound Core Music & Video | Studio Production</title>
...
?>
	...
	<section id='content'>
			...
			<h3 id="header">Studio Productions</h3>
			<p id='subtitle'>Call for pricing. Below is a demo of our recordings that we have done.</p>
			
			<div id='leftButton'></div>
			<div id='rightButton'></div>	
			
			<div id="media">
					<iframe class='content' src="https://www.youtube.com/embed/o4a21DPUQsQ" frameborder="0" allowfullscreen></iframe>
					<iframe class='content' src="https://www.youtube.com/embed/KIZcKDKx1c8" frameborder="0" allowfullscreen></iframe>
					<iframe class='content' src="https://www.youtube.com/embed/5pFQ-tJCFbE" frameborder="0" allowfullscreen></iframe>
