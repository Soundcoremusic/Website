...
<meta name="description" content="Sound Core offers audio and video transfers to many data formats. We can convert from older formats such as film or record to newer formats such as CD or DVD.">
<meta name="keywords" content="audio transfers carbondale, video transfers carbondale, data transfer carbondale">
<meta charset='UTF-8'>

<title>Sound Core Music & Video | Services - Audio and Video Transfers</title>
<link rel='stylesheet' type='text/css' href='../css/VideoProductionTheme.css'>
<link rel='stylesheet' type='text/css' href='../css/AV_transfers.css'>
...
?>
	...
	<section id='content'>
			<h3 id='header'>Media Conversion</h3>
			<p id='headerSub'>Needing a place to convert your favorite memories? Sound Core can convert your media to a format that is needed.</p>
			...
			<div id='media'>
				<img class='content' src='../images/vinyl2.jpg'>
				<img class='content' src='../transfers/film.jpg'>
				<img class='subtitle' src='../transfers/audioTransSubtitle.png'>
				<img class='subtitle' src='../transfers/videoTransSubtitle.png'>
			...
			<div id='avBottom'>
					...
					<h2 id='formats'>Formats may include</h2>
					<ul class='transfersList'>
						<li class='types'>DVD</li>
						<li class='types'>CD</li>
						<li class='types'>Cassette Tapes</li>
						<li class='types'>Vinyl (Records)</li>
						<li class='types'>Photographs</li>
						<li class='types'>Slides</li>
						<li class='types'>DV Tapes</li>
					</ul>
					<ul class='transfersList'>
						<li class='types'>Mini DV</li>
						<li class='types'>8mm Film</li>
						<li class='types'>16mm Film</li>
						<li class='types'>VHS</li>
						<li class='types'>USB</li>
					</ul>
